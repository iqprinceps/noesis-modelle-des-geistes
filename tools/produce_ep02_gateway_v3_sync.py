#!/usr/bin/env python3
"""Word-anchored final cut of Gateway: visuals start at the matching spoken phrase."""
...
PROD = ROOT / "06_PRODUCTION" / "EP02_GATEWAY_V3_SYNC"
...
TIMELINE = PROD / "timeline" / "EP02_GATEWAY_V3_SYNC_timeline.json"
...
def semantic_shots():
    ...
    shots = [
        ...
        item("Der zweite soll", doc("V3_DOC09_RECOMMENDATION_H.png"), "S1", label="PAST · IN THE REPORT"),
        ...
        item("Genau dieser Versuch", doc("V3_DOC09_RECOMMENDATION_H.png"), "S1", label="ORIGINAL PASSAGE"),
        item("Datum:", doc("V3_DOC01_ARMY_HEADER_DATE.png"), "S1", label="9 JUNE 1983"),
        item("Autor:", doc("V3_DOC03_MCDONNELL_SIGNATURE.png"), "S1", label="WAYNE M. McDONNELL"),
        item("Heute liegt", doc("V3_DOC01_ARMY_HEADER_DATE.png"), "S1", label="CIA ARCHIVE COPY · ARMY REPORT"),
        ...
        item("Sie lautet:", doc("V3_DOC09_RECOMMENDATION_H.png"), "S1", label="PROPOSED PROCEDURE"),
        ...
        item("Wayne McDonnell sollte", doc("V3_DOC03_MCDONNELL_SIGNATURE.png"), "S2", label="DOCUMENTED AUTHOR", title="WAYNE M. McDONNELL"),
        item("Sein Auftrag war", doc("V3_DOC02_TASK_BENTOV.png"), "S2", label="THE ASSIGNED TASK"),
        item("Auf der Titelseite", doc("V3_DOC01_ARMY_HEADER_DATE.png"), "S2", label="DEPARTMENT OF THE ARMY"),
        item("Am Ende des Schreibens", doc("V3_DOC03_MCDONNELL_SIGNATURE.png"), "S2", label="NAME · RANK · SIGNATURE"),
        ...
        item("Im Gateway-Bericht", doc("V3_DOC02_TASK_BENTOV.png"), "S2", label="BENTOV IN THE REPORT"),
        ...
        item("Von Wayne McDonnell", doc("V3_DOC03_MCDONNELL_SIGNATURE.png"), "S2", label="NO VERIFIED PORTRAIT"),
        item("Seine Person wird", doc("V3_DOC03_MCDONNELL_SIGNATURE.png"), "S2", label="NO INVENTED FACE"),
        item("Wir bleiben bei", doc("V3_DOC03_MCDONNELL_SIGNATURE.png"), "S2", label="TEXT · RANK · SIGNATURE"),
        ...
        item("McDonnell will nicht", doc("V3_DOC03_MCDONNELL_SIGNATURE.png"), "S4", label="THE AUTHOR'S MODEL"),
        ...
        item("Dann steht dort", doc("V3_DOC04_FOCUS15_HEADING.png"), "S5", label="FOCUS 15 · IN THE REPORT"),
        ...
        item("McDonnell schreibt zugleich", doc("V3_DOC05_LESS_THAN_FIVE_PERCENT.png"), "S5", label="DIFFICULTY WARNING"),
        item("weniger als fünf Prozent", doc("V3_DOC05_LESS_THAN_FIVE_PERCENT.png"), "S5", label="LESS THAN FIVE PERCENT"),
        item("Die nächste Überschrift", doc("V3_DOC06_FOCUS21_FUTURE.png"), "S5", label="FOCUS 21 · IN THE REPORT"),
        item("außerhalb normaler Raum-Zeit", oldai("STYLE_REFERENCES", "IMG02_GW_STYLE_CONCEPTUAL_16x9.png"), "S5", label="MODEL VISUALIZATION"),
        item("Direkt darunter", doc("V3_DOC07_OBE_NO_GUARANTEE.png"), "S5", label="THE OUT-OF-BODY MOVEMENT"),
        item("garantiere keinen Erfolg", doc("V3_DOC07_OBE_NO_GUARANTEE.png"), "S5", label="NO GUARANTEE"),
        item("Trotzdem folgen", oldai("AI_RECONSTRUCTIONS", "IMG06_GW_OUT_OF_BODY_CONCEPT_16x9.png"), "S5", label="RECONSTRUCTION"),
        item("Hier muss das Bild", doc("V3_DOC07_OBE_NO_GUARANTEE.png"), "S5", label="READ THE COMPLETE PASSAGE"),
        ...
        item("Information Collection Potential", doc("V3_DOC08_INFORMATION_COLLECTION.png"), "S6", label="INFORMATION COLLECTION"),
        item("Eindrücke aus Gegenwart", doc("V3_DOC08_INFORMATION_COLLECTION.png"), "S6", label="THE REPORT'S DISTORTION PROBLEM"),
        item("zehn computergenerierte Zahlen", doc("V3_DOC08_INFORMATION_COLLECTION.png"), "S6", label="TEN COMPUTER-GENERATED NUMBERS"),
        item("manche hätten genug", doc("V3_DOC08_INFORMATION_COLLECTION.png"), "S6", label="SOME DIGITS"),
        item("Alle zehn richtig", doc("V3_DOC08_INFORMATION_COLLECTION.png"), "S6", label="NEVER ALL TEN"),
        item("Empfehlung H", doc("V3_DOC09_RECOMMENDATION_H.png"), "S6", label="RECOMMENDATION H"),
        ...
        item("Eine in Focus 15", doc("V3_DOC09_RECOMMENDATION_H.png"), "S6", label="PAST · FOCUS 15"),
        item("Eine in Focus 21", doc("V3_DOC09_RECOMMENDATION_H.png"), "S6", label="FUTURE · FOCUS 21"),
        item("alle drei Berichte", card("V2_CARD01_THREE_OBSERVERS.png"), "S6", label="COMPARE REPORTS"),
        item("Der Absatz ist echt", doc("V3_DOC09_RECOMMENDATION_H.png"), "S6", label="THE PARAGRAPH IS REAL"),
        item("Ein erfolgreicher Versuch", card("V2_CARD04_TEST_PROTOCOL.png"), "S6", label="NO SUCCESSFUL TEST REPORTED"),
        item("Die nächsten Empfehlungen", doc("V3_DOC10_NONCORPOREAL_FORMS.png"), "S6", label="THE NEXT RECOMMENDATIONS"),
        item("nicht-körperlichen Energieformen", doc("V3_DOC10_NONCORPOREAL_FORMS.png"), "S6", label="RECOMMENDATION J"),
        item("holografische Muster", doc("V3_DOC11_HOLOGRAPHIC_BARRIER.png"), "S6", label="RECOMMENDATION K"),
        ...
        item("Der Bericht ist echt", doc("V3_DOC01_ARMY_HEADER_DATE.png"), "S8", label="DOCUMENTED"),
        item("Datum, Auftrag", doc("V3_DOC03_MCDONNELL_SIGNATURE.png"), "S8", label="DATE · TASK · AUTHOR"),
        ...
        item("tatsächliche Geschichte", doc("V3_DOC09_RECOMMENDATION_H.png"), "S8", label="THE ACTUAL DOCUMENT"),
        item("Test mit Beobachtern", card("V2_CARD01_THREE_OBSERVERS.png"), "S8", label="PAST · PRESENT · FUTURE"),
        item("nicht-körperliche Intelligenzen", doc("V3_DOC10_NONCORPOREAL_FORMS.png"), "S8", label="RECOMMENDATION J"),
        item("mentale Schutzmuster", doc("V3_DOC11_HOLOGRAPHIC_BARRIER.png"), "S8", label="RECOMMENDATION K"),
        item("Nicht der Beweis", doc("V3_DOC12_IF_EXPERIMENTS_CARRIED_THROUGH.png"), "S8", label="THE CONDITIONAL ENDING"),
        item("Der Fund ist diese Seite", doc("V3_DOC09_RECOMMENDATION_H.png"), "S8", label="THE IMPOSSIBLE · PLANNED ON PAPER"),
    ]
    return shots
...
def build_timeline():
    ...
    for i, (shot, start) in enumerate(zip(shots, starts), 1):
        ...
        row.update({"anchor": shot["anchor"], "shot_id": f"GWV3_{i:03d}", "start": round(start, 3),
    ...
    (PROD / "captions" / "EP02_GATEWAY_V3_SYNC_de.srt").write_bytes(SRT.read_bytes())
...
def graphics(rows):
    path = PROD / "render" / "EP02_GATEWAY_V3_SYNC_graphics.ass"
...
def render(force=False, limit=None):
    ...
    picture = PROD / "render" / "EP02_GATEWAY_V3_SYNC_picture_lock.mp4"
    ...
    out = FINAL / "EP02_GATEWAY_V3_SYNC_FINAL_1080p.mp4"
...
def qa():
    video = FINAL / "EP02_GATEWAY_V3_SYNC_FINAL_1080p.mp4"
    ...
    (FINAL / "EP02_GATEWAY_V3_SYNC_QA.json").write_text(json.dumps(report, indent=2) + "\n", encoding="utf-8")
    run(["ffmpeg", "-y", "-hide_banner", "-loglevel", "error", "-i", str(video), "-vf", "fps=1/32,scale=384:216,tile=5x4", "-frames:v", "1", "-q:v", "2", str(FINAL / "EP02_GATEWAY_V3_SYNC_CONTACT_SHEET.jpg")])
