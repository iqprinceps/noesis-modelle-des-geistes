...
ASSET_EP = ROOT / "07_ENGLISH_PRODUCTION" / "EP13_VATICAN_01"
AUTH = ASSET_EP / "03_VISUALS" / "ASSETS" / "SELECTED" / "AUTHENTIC"
GEN = ASSET_EP / "03_VISUALS" / "ASSETS" / "SELECTED" / "GENERATED"
...
def variant_a():
    ...
    tracked(d, (104, 762), "DIE KUGEL", f(SERIF_B, 150), CREAM, 6)
    tracked(d, (104, 912), "IN DER KRONE", f(SERIF_B, 150), EMBER, 6)
    return im, "EP13_DE_THUMB_A_OBJECT.jpg", "the ringed object, named, no question asked"


def variant_b():
    """The object plus the question the episode answers."""
    im, d = crown(1.02, (0.50, 0.46), 214)
    tracked(d, (104, 692), "AUF EINEN PAPST", f(SERIF_B, 130), CREAM, 5)
    tracked(d, (104, 820), "GEFEUERT.", f(SERIF_B, 130), CREAM, 5)
    d.text((108, 966), "Warum steckt sie in einer Krone?", font=f(SERIF_I, 82), fill=(0, 0, 0))
    d.text((104, 962), "Warum steckt sie in einer Krone?", font=f(SERIF_I, 82), fill=EMBER)
    return im, "EP13_DE_THUMB_B_QUESTION.jpg", "ringed object plus the question, strongest promise"
...
def variant_c():
    ...
    d = ImageDraw.Draw(im)
    tracked(d, (110, 700), "ZWEI PÄPSTE", f(SERIF_B, 140), CREAM, 5)
    tracked(d, (110, 836), "LASEN IHN.", f(SERIF_B, 140), CREAM, 5)
    d.text((118, 984), "Keiner sagte, was darin stand.", font=f(SERIF_I, 76), fill=(0, 0, 0))
    d.text((114, 980), "Keiner sagte, was darin stand.", font=f(SERIF_I, 76), fill=EMBER)
    return im, "EP13_DE_THUMB_C_SEALED.jpg", "the sealed document angle"
