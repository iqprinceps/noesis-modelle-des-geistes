#!/usr/bin/env python3
"""Render the EP04A Jung/Kundalini cut, V3.

V3 keeps the V2 voice master, cue grid and total duration byte-identical and
changes only what sits inside the cues: denser shot subdivision from the unused
asset pool, a raised camera-travel floor that leaves peak speed low, two
readable reset frames instead of flat black, and a -1 dBTP delivery limit.
...
TIMELINE = RENDER / "timeline" / "EP04A_RENDER_TIMELINE_V3.json"
RENDER_MANIFEST = RENDER / "EP04A_RENDER_MANIFEST_V3.json"
VIDEO_ONLY = FINAL / "EP04A_JUNG_KUNDALINI_VIDEO_ONLY_V3.mp4"
OUTPUT = FINAL / "EP04A_JUNG_KUNDALINI_FINAL_V3.mp4"
...
def create_editorial_assets() -> dict[str, Path]:
    ...
    rng_seed = 40419
    # V3: the two reset beats stay dark but must not decode as a flat black
    # frame -- on a phone that reads as "video ended".  A wide, very soft pool
    # of light off the upper left keeps the shot alive without brightening it
    # into a picture; peak luma stays far below any other shot in the cut.
    dry = Image.new("RGB", (2560, 1440), BG)
    glow = Image.new("L", (2560, 1440), 0)
    glow_draw = ImageDraw.Draw(glow)
    glow_draw.ellipse((-620, -900, 2180, 1500), fill=104)
    glow_draw.ellipse((240, -420, 1740, 1080), fill=176)
    glow = glow.filter(ImageFilter.GaussianBlur(320))
    dry = Image.composite(Image.new("RGB", (2560, 1440), (64, 63, 74)), dry, glow)
    ...
    dry_path = ASSETS / "EP04A_A027_DRY_BLACK_ROOM_V3.png"
    ...
    line_path = ASSETS / "EP04A_A062_MINIMAL_PROBLEM_LINE_V3.png"
...
def special_assets(editorial: dict[str, Path]) -> dict[str, list[Path]]:
    ...
    return {
        ...
        "A001": [
            legacy("EP04_S5_052_zuerich_1932.png"),
            MAIN / "EP04A_IMG001_SEMINAR_ROOM_WIDE.png",
        ],
        "A002": [
            legacy("EP04_S5_060_kundalini_an_der_wurzel.png"),
            legacy("EP04_S4_051_indisches_blatt_am_tisch.png"),
        ],
        "A003": [
            legacy("EP04_S5_057_jung_am_rednerpult.png"),
            legacy("EP04_S5_059_zwei_zuhoerer.png"),
            MAIN / "EP04A_IMG022_SEMINAR_JUNG_HAND_POINTER.png",
        ...
        "A007": [
            ...
            legacy("EP04_S4_050_pergament_wird_entrollt.png"),
            # Eine echte indische Chakra-Platte von 1899 statt einer erzeugten
            # europaeischen Buchmalerei -- der Text sagt hier "eine indische Karte".
            REFS / "EP04B" / "01_ORIGINAL_GREEN" / "HISTORICAL_CHAKRA" / "EP04B_Sapta_Chakra_1899_PD.jpg",
        ...
        "A009": [
            ...
            legacy("EP04_S1_005_zerrissener_brief.png"),
        ],
        ...
        "A013": [
            REFS / "EP04A" / "01_ORIGINAL_GREEN" / "CLINIC" / "EP04A_Burghoelzli_c1890_PD.jpg",
        ...
        "A016": [
            legacy("EP04_S1_008_truemmer_im_wasser.png"),
            legacy("EP04_S1_006_haende_auf_den_knien.png"),
            legacy("EP04_S8_106_der_leere_stuhl.png"),
        ],
        ...
        "A018": [
            ...
            legacy("EP04_S2_026_dielen_und_schreibtischbein.png"),
            legacy("EP04_S4_042_naechtliche_notizen.png"),
        ...
        "A023": [
            legacy("EP04_S3_030_schwarze_schlange_schiefer.png"),
            MAIN / "EP04A_IMG018_BLACK_SNAKE_CAVE_WIDE.png",
        ],
        "A024": [
            legacy("EP04_S3_028_elias.png"),
            legacy("EP04_S3_029_salome.png"),
            legacy("EP04_S3_032_philemon.png"),
            legacy("EP04_S3_033_eisvogelgefieder.png"),
            legacy("EP04_S2_022_zwei_gestalten_gewoelbe.png"),
        ...
        "A028": [
            REFS / "EP04A" / "02_REVIEW_YELLOW" / "PLACES" / "EP04A_Zuerich_Bahnhofplatz_1930_CC-BY-SA-4.0.jpg",
            legacy("EP04_S5_054_der_vortragssaal.png"),
        ],
        "A029": [
        ...
        "A030": [
            ...
            legacy("EP04_S7_091_das_blatt_von_1577.png"),
        ...
        "A032": [
            ...
            legacy("EP04_S8_108_schaufenster_am_abend.png"),
            REFS / "EP04A" / "01_ORIGINAL_GREEN" / "CLINIC_OBJECTS"
            / "EP04A_Jung_Galvanometer_Burghoelzli_1904_1905_PD.png",
        ],
        "A033": [MAIN / "EP04A_IMG025_INNER_GRAVITY_ROOM.png", legacy("EP04_S5_065_kamin_im_arbeitszimmer.png")],
        "A034": [
            MOTION / "A-G07_BODEN_AFFEKT_ABSTAND.png",
            MAIN / "EP04A_IMG024_EMPTY_VESSEL_METAPHOR.png",
            legacy("EP04_S3_040_autonome_struktur.png"),
        ],
        ...
        "A035": [
            ...
            MAIN / "EP04A_IMG026_MULADHARA_GROUND.png",
        ...
        "A042": [
            ...
            editorial["meaning"],
            RESERVE / "EP04A_RSV05_FIRE_TO_AIR_ABSTRACT.png",
            legacy("EP04_S6_080_offenes_fenster.png"),
        ],
        "A043": [legacy("EP04_S6_081_zwei_stuehle.png")],
        "A044": [
            MAIN / "EP04A_IMG034_PHONE_NAME_ONLY.png",
            REWORK / "EP04A_REWORK_PHONE_MESSAGE_2K.png",
        ],
        "A045": [MAIN / "EP04A_IMG035_BODY_REACTION_SEQUENCE_STILL.png", legacy("EP04_S6_071_schreibtisch_der_sorgen.png")],
        "A046": [
            REWORK / "EP04A_REWORK_PHONE_REPLY_HOVER_2K.png",
            MAIN / "EP04A_IMG036_REPLY_FORMING_UNREADABLE.png",
            RESERVE / "EP04A_RSV06_PHONE_ROOM_ALT.png",
        ],
        "A047": [MAIN / "EP04A_IMG037_TWO_SECOND_HOVER.png"],
        "A048": [
            MAIN / "EP04A_IMG038_RELEASE_PULLBACK.png",
            legacy("EP04_S8_112_land_ohne_wege.png"),
            legacy("EP04_S3_034_kiesweg_im_garten.png"),
            legacy("EP04_S8_115_zuerichsee_bei_nacht.png"),
        ...
        "A049": [
            ...
            MAIN / "EP04A_IMG040_EMPTY_TRACING_LAYERS.png",
            legacy("EP04_S7_095_der_esoterikladen.png"),
        ],
        "A050": [
            MAIN / "EP04A_IMG039_LONDON_PRINT_PROCESS_1919.png",
            ASSETS / "SHARED_BOOK_001_TITLE_1924.png",
        ],
        ...
        "A053": [
            MOTION / "A-G12_SECHS_SAHASRARA.png",
            ASSETS / "SHARED_BOOK_001_ILLUSTRATIONS.png",
            legacy("EP04_S7_093_vers_ueber_sahasrara.png"),
            lotus,
        ],
        "A054": [
            REFS / "EP04B" / "01_ORIGINAL_GREEN" / "PORTRAITS" / "EP04B_Leadbeater_c1925_PD.jpg",
            legacy("EP04_S7_097_farbtherapie_apparat.png"),
        ],
        "A055": [
            legacy("EP04_S7_087_high_court_kalkutta.png"),
            MOTION / "A-G13_KARTE_REIST.png",
            legacy("EP04_S8_103_folio_in_der_vitrine.png"),
            legacy("EP04_S7_086_portraet_woodroffe.png"),
        ],
        "A056": [
            REFS / "EP04A" / "01_ORIGINAL_GREEN" / "PORTRAITS" / "EP04A_Jung_portrait_PD.jpg",
            REFS / "EP04A" / "02_REVIEW_YELLOW" / "PORTRAITS" / "EP04A_Jung_Burghoelzli_ca1909_1910.jpg",
        ],
        "A057": [legacy("EP04_S7_101_ueberblendung_hoehle_tafel.png"), MAIN / "EP04A_IMG043_BLACK_SNAKE_RESIDUE.png"],
        "A058": [
            legacy("EP04_S6_082_ajna.png"),
            legacy("EP04_S4_041_die_schwarzen_hefte.png"),
            legacy("EP04_S4_048_farbschichten_detail.png"),
        ],
        "A059": [
            editorial["composite"],
            legacy("EP04_S7_087_die_richter.png"),
            legacy("EP04_S8_104_der_tresorraum.png"),
            legacy("EP04_S8_105_behandschuhte_haende.png"),
            legacy("EP04_S3_035_kurrentschrift.png"),
        ...
        "A061": [
            ...
            legacy("EP04_S8_116_eth_zuerich.png"),
...
def build_timeline() -> list[dict]:
    ...
    RENDER_MANIFEST.write_text(json.dumps({
        ...
        "assets": asset_ledger,
        "motion": "V3 restrained 8K/120fps still camera with raised travel floor; cards locked; source clips unmodified spatially",
        "editorial_rules": {
            "direct_duplicate_assets": 0,
            "blank_notebook_board_paper_motifs": 0,
            "card_camera_motion": "none",
            "video_camera_motion": "none",
            "reconstruction_labels": "none (editorial decision, see README)",
            "voice_master": "unchanged from V2; cue grid and total duration identical",
...
def camera_filter(index: int, shot: dict) -> str:
    ...
    # V3 camera.  The complaint about V2 was never peak speed -- it was that
    # 41 of 105 stills barely travelled at all while sitting on screen for five
    # seconds.  So the floor goes up and the ceiling stays where it was: pans
    # get real headroom to move through (higher base zoom), zoom legs get a
    # slightly longer throw, and the tempo term stays clamped near 1.
    tempo = min(1.05, max(.70, shot["duration"] / 6.2))
    pan_tempo = .62 * tempo
    ...
    if shot["contain"]:
        pairs = [(1.020, .030), (1.055, -.026)]
        z0, dz = pairs[index % 2]
        z1 = z0 + dz * tempo
        x, y = center_x, center_y
    else:
        movements = [
            (1.026, .034, center_x, center_y),
            (1.060, -.028, center_x, center_y),
            # Pure pans need crop headroom or they crawl: at z=1.045 the whole
            # traversable distance is 4.3% of the frame, which is what produced
            # the near-frozen shots in V2.
            (1.078, 0.0, traverse(right), center_y),
            (1.078, 0.0, traverse(right, True), center_y),
            (1.072, 0.0, center_x, traverse(down, True)),
            (1.030, .026, traverse(right), traverse(down)),
            (1.082, -.022, traverse(right, True), center_y),
            (1.072, 0.0, center_x, traverse(down)),
        ]
        z0, dz, x, y = movements[index % 8]
        z1 = z0 + dz * tempo
    z1 = min(1.098, max(1.012, z1))
...
def assemble(shots: list[dict]) -> None:
    ...
    audio_filter = (
        ...
        # V3 delivery stage.  A bare alimiter was measured to make things
        # worse: a lower ceiling compresses more, lifts the integrated level
        # and rides hard enough to push intersample peaks to 0 dBTP.  Limit on
        # a 192 kHz oversample, then let loudnorm do the true-peak controlled
        # landing at the -14 LUFS the platform normalizes to anyway.
        f"[base][outro]amix=inputs=2:duration=longest:normalize=0,"
        f"atrim=0:{target_duration:.6f},"
        f"aresample=192000,alimiter=limit=.89,aresample=48000,"
...
def qa(shots: list[dict]) -> None:
    ...
    (FINAL / "EP04A_FINAL_QA_V3.json").write_text(
