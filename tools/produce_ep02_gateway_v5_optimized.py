#!/usr/bin/env python3
"""Gateway V5.1 — Maximum variety, better text-image matching.

Changes from V5:
- Max 3x per visual asset (down from 7x)
- Uses 17 previously unused assets
- Better text-image semantic matching
- More motion clips for visual breathing room
"""
...
def semantic_shots():
    ...
    # Motion clips
    motion1 = mot("motion_1.mp4")  # Abstract particles
    motion2 = mot("motion_2.mp4")  # Abstract waves
    motion4 = mot("motion_4.mp4")  # Abstract light

    # Previously unused AI images - now used!
    ...
    shots = [
        # S1 — Hook (0:00 - 0:50) - 14 shots
        item("Drei Menschen.", ai_observers, "S1", label="THREE OBSERVERS"),
        ...
        # S2 — The three men (0:50 - 2:15) - 18 shots
        ...
        item("Teilnehmer hörten", ai_binaural, "S2", label="LISTENING WITH HEADPHONES"),
        ...
        # S3 — Mechanism (2:15 - 3:35) - 17 shots
        item("Der Einstieg ist", ex("GW_002_Exhibit_1A.png"), "S3", label="EXHIBIT 1A"),
        item("Hört das linke Ohr", research("GW_IMG_002_PMC7082494_Figure1_Binaural_vs_Monaural.jpg"), "S3", label="BINAURAL BEAT"),
        ...
        # S4 — World model (3:35 - 5:20) - 18 shots
        ...
        item("Der Körper schwingt", ai_consciousness, "S4", label="BODY · MODEL"),
        ...
        item("Raum und Zeit", ai_timewheel, "S4", label="THE TIME WHEEL"),
        ...
        # S5 — Focus levels (5:20 - 7:10) - 15 shots
        ...
        item("Zeit soll", ai_timewheel, "S5", label="THE TIME WHEEL MODEL"),
        ...
        item("außerhalb normaler Raum-Zeit", ai_consciousness, "S5", label="MODEL VISUALIZATION"),
        ...
        item("Trotzdem folgen", ai_barrier, "S5", label="THE COMPLETE PASSAGE"),
        ...
        # S6 — Operational claims (7:10 - 9:05) - 20 shots
        ...
        item("Drei Personen", ai_observers, "S6", label="THREE OBSERVERS"),
        ...
        # S7 — Evidence (9:05 - 10:55) - 15 shots
        ...
        # S8 — Residue (10:55 - 12:00) - 14 shots
