#!/usr/bin/env python3
"""EP13_DE music, SFX and final mix.

# German cut. The score follows the same eleven act turns as the English one,
# but German takes 555 s where English takes 488, so each boundary was moved to
# the time of the same beat in the German alignment rather than scaled by a
# ratio. The effects are keyed to visual states and need no adjustment.
...
CUE = EP / "05_DELIVERY" / "EP13_DE_VISUAL_CUE_SHEET.csv"
VOICE = EP / "02_VOICE" / "MASTER" / "EP13_DE_VO_MASTER.wav"
PICTURE = ROOT / "tmp" / "render" / "ep13_de" / "EP13_DE_PICTURE.mp4"
AUDIO = EP / "04_AUDIO"
STEMS = AUDIO / "stems"
MIXWAV = AUDIO / "EP13_DE_FINAL_MIX.wav"
FINAL = EP / "05_DELIVERY" / "EP13_DE_FINAL.mp4"
...
SECTIONS = [
    ...
    ("becomes_object", 59.46, "paper"),
    ("the_waiting", 116.76, "held"),
    ("the_attack", 177.62, "pressure"),
    ("the_room", 206.8, "held"),
    ("the_reveal", 249.54, "vision"),
    ("the_absence", 311.88, "vision"),
    ("recognition", 342.38, "paper"),
    ("the_crown", 416.33, "object"),
    ("the_form", 481.4, "held"),
    ("handoff", 517.04, "pressure"),
]
