#!/usr/bin/env python3
"""Gateway V5 FINAL — Optimized production with motion clips.

Major improvements:
- Max 3x repetition per visual asset
- New patent crops showing full important content
- Motion clips for visual variety
- No RECONSTRUCTION labels
- Better document framing
"""
...
def semantic_shots():
    ...
    shots = [
        # S1 — Hook (0:00 - 0:50)
        item("Drei Menschen.", ex("GW_003_Exhibit_1B.png"), "S1", label="EXHIBIT 1B"),
        item("Der erste beobachtet", card("V2_CARD01_THREE_OBSERVERS.png"), "S1", label="PRESENT"),
        item("Der zweite soll", doc("V4_DOC09_RECOMMENDATION_H.png"), "S1", label="RECOMMENDATION H"),
        item("Der dritte aus", rp("GW_REPORT_PDF28_RECOMMENDATIONS_H_L.png"), "S1", label="PAST AND FUTURE"),
        item("Danach werden", ex("GW_003_Exhibit_1B.png"), "S1", label="COMPARE REPORTS"),
        ...
        item("Sie lautet:", doc("V4_DOC09_RECOMMENDATION_H.png"), "S1", label="THE PROPOSED PROCEDURE"),
        item("Die Antwort beginnt", rp("GW_REPORT_PDF01_HEADER.png"), "S1", label="THE REPORT"),

        # S2 — The three men (0:50 - 2:15)
        item("Robert Monroe entwickelte", luna("GWV2_IMG_002_Fort_Meade_historical_aerial_PD.jpg"), "S2", label="MONROE INSTITUTE · VIRGINIA"),
        item("Sein historischer Markenbegriff", pat("V5_PATENT_MONROE_BINAURAL.png"), "S2", label="HEMI-SYNC · PATENT METHOD"),
        item("Teilnehmer hörten", pat("V5_PATENT_MONROE_EEG.png"), "S2", label="U.S. PATENT 5,213,562"),
        ...
        item("Für die theoretische Brücke", pat("V5_PATENT_BENTOV_1971_DRAWING.png"), "S2", label="BENTOV PATENT · 1971"),
        item("Bentov war Autor", pat("V5_PATENT_BENTOV_1971_CLAIMS.png"), "S2", label="PATENT CLAIMS"),
        item("Seine Patente zeigen", pat("V5_PATENT_BENTOV_1971_DRAWING.png"), "S2", label="U.S. PATENT 3,605,725"),
        item("Katheter", rp("GW_PATENT_PDF02.png"), "S2", label="ELECTRODE DESIGN"),
        item("Im Gateway-Bericht", doc("V4_DOC02_TASK_BENTOV.png"), "S2", label="BENTOV IN THE REPORT"),
        item("Monroe lieferte", pat("V5_PATENT_MONROE_BINAURAL.png"), "S2", label="TRAINING SYSTEM · PATENT"),
        item("Bentov lieferte", pat("V5_PATENT_BENTOV_1971_CLAIMS.png"), "S2", label="ANALOGIES · PATENT"),
        ...
        item("Hört das linke Ohr", research("GW_IMG_002_PMC7082494_Figure1_Binaural_vs_Monaural.jpg"), "S3", label="BINAURAL BEAT DIAGRAM"),
        ...
        item("Wer danach ruhiger", motion4, "S3", kind="VIDEO", label="A COMPLETE TRAINING"),
        item("Ein späteres Patent", pat("V5_PATENT_MONROE_BINAURAL.png"), "S3", label="U.S. PATENT 5,213,562"),
        item("EEG-Muster", pat("V5_PATENT_MONROE_EEG.png"), "S3", label="EEG PATTERNS"),
        item("Es wurde 1993", rp("GW_PATENT_PDF03.png"), "S3", label="PATENT DISCLOSURE"),
        item("Das Patent zeigt", rp("GW_PATENT_PDF04.png"), "S3", label="PATENT CLAIMS"),
        ...
        item("Bis hierhin", card("V2_CARD05_EVIDENCE_SCALE.png"), "S3", label="EVIDENCE SCALE"),
        item("Dann macht", card("V2_CARD03_MECHANISM_LADDER.png"), "S3", label="THE CLAIM JUMP"),

        # S4 — World model (3:35 - 5:20)
        item("McDonnell will nicht", rp("GW_REPORT_PDF01_HEADER.png"), "S4", label="THE REPORT"),
        ...
        item("Der Körper schwingt", motion1, "S4", kind="VIDEO", label="BODY · MODEL"),
        ...
        item("Raum und Zeit", rp("GW_REPORT_PDF24_FOCUS15_21.png"), "S4", label="THE TIME WHEEL"),
        item("Auf dem Papier", ex("GW_009_Exhibit_4C.png"), "S4", label="FORMULAS AND DIAGRAMS"),
        item("Doch die Zahnräder", card("V2_CARD05_EVIDENCE_SCALE.png"), "S4", label="NO DEMONSTRATED BRIDGE"),
        item("Eine Analogie", pat("V5_PATENT_BENTOV_1971_DRAWING.png"), "S4", label="BENTOV PATENT"),
        item("entscheidende Wechsel", motion4, "S4", kind="VIDEO", label="PHENOMENON → THEORY"),
        item("eine Art Landkarte", rp("GW_REPORT_PDF24_FOCUS15_21.png"), "S4", label="THE FOCUS LEVELS"),

        # S5 — Focus levels (5:20 - 7:10)
        item("Focus 10 bedeutet", doc("V5_DOC_FOCUS15_FULL.png"), "S5", label="FOCUS 10"),
        item("Focus 12 soll", doc("V5_DOC_FOCUS21_FULL.png"), "S5", label="FOCUS 12"),
        item("Dann steht dort", doc("V4_DOC04_FOCUS15_HEADING.png"), "S5", label="FOCUS 15"),
        item("Zeit soll", rp("GW_REPORT_PDF24_FOCUS15_21.png"), "S5", label="THE TIME WHEEL MODEL"),
        ...
        item("außerhalb normaler Raum-Zeit", motion2, "S5", kind="VIDEO", label="MODEL VISUALIZATION"),
        ...
        item("Trotzdem folgen", motion4, "S5", kind="VIDEO", label="THE COMPLETE PASSAGE"),
        ...
        item("Nicht dokumentiert", card("V2_CARD05_EVIDENCE_SCALE.png"), "S5", label="NOT DOCUMENTED"),
        ...
        item("Alle zehn richtig", doc("V5_DOC_TEN_DIGITS.png"), "S6", label="NEVER ALL TEN"),
        item("Empfehlung H", doc("V5_DOC_RECOMMENDATION_H_FULL.png"), "S6", label="RECOMMENDATION H"),
        item("Drei Personen", card("V2_CARD01_THREE_OBSERVERS.png"), "S6", label="THREE OBSERVERS"),
        ...
        item("Eine in Focus 15", doc("V5_DOC_RECOMMENDATION_H_FULL.png"), "S6", label="PAST · FOCUS 15"),
        item("Eine in Focus 21", doc("V5_DOC_RECOMMENDATION_JK.png"), "S6", label="FUTURE · FOCUS 21"),
        item("alle drei Berichte", motion1, "S6", kind="VIDEO", label="COMPARE REPORTS"),
        item("Der Absatz ist echt", doc("V4_DOC09_RECOMMENDATION_H.png"), "S6", label="THE PARAGRAPH IS REAL"),
        item("Ein erfolgreicher Versuch", card("V2_CARD04_TEST_PROTOCOL.png"), "S6", label="NO TEST REPORTED"),
        item("Die nächsten Empfehlungen", doc("V5_DOC_RECOMMENDATION_JK.png"), "S6", label="RECOMMENDATION J"),
        ...
        item("unerwünschte außerkörperliche", doc("V5_DOC_EXPERIMENTS_ENDING.png"), "S6", label="HOLOGRAPHIC BARRIER"),
        ...
        item("kein Beleg für Gateway", card("V2_CARD05_EVIDENCE_SCALE.png"), "S7", label="NOT THE WHOLE SYSTEM"),
        ...
        item("neue, überprüfbare Information", card("V2_CARD04_TEST_PROTOCOL.png"), "S7", label="VERIFIABLE INFORMATION"),
        ...
        item("verborgenes Ziel", card("V2_CARD04_TEST_PROTOCOL.png"), "S7", label="A FINDING ABOUT INFORMATION"),
        ...
        item("Focus Levels", rp("GW_REPORT_PDF24_FOCUS15_21.png"), "S8", label="FOCUS LEVELS"),
        item("militärische Interesse", ex("GW_013_DISA_headquarters_exterior.jpg"), "S8", label="DISA HEADQUARTERS"),
        item("Bewusstsein könne", rp("GW_REPORT_PDF27_CONCLUSION_A_G.png"), "S8", label="CLAIM IN THE REPORT"),
        item("keinen belastbaren", card("V2_CARD05_EVIDENCE_SCALE.png"), "S8", label="NO OPERATIONAL EVIDENCE"),
        ...
        item("nicht-körperliche Intelligenzen", doc("V5_DOC_RECOMMENDATION_JK.png"), "S8", label="RECOMMENDATION J"),
        item("mentale Schutzmuster", doc("V4_DOC11_HOLOGRAPHIC_BARRIER.png"), "S8", label="RECOMMENDATION K"),
        item("Nicht der Beweis", doc("V4_DOC12_IF_EXPERIMENTS_CARRIED_THROUGH.png"), "S8", label="CONDITIONAL ENDING"),
