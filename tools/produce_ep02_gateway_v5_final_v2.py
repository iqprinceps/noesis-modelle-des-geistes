#!/usr/bin/env python3
"""Gateway V5.2 — Maximum variety with new card visuals.

Changes from V5.1:
- 7 new card visuals created
- Max 3x per visual asset
...
def semantic_shots():
    ...
    v5card = lambda n: p("visuals", "cards", n)  # NEW V5 cards!
    ...
    shots = [
        ...
        item("Hört das linke Ohr", card_binaural, "S3", label="BINAURAL BEAT"),
        ...
        item("Bis hierhin", card_evidence, "S3", label="EVIDENCE SCALE"),
        ...
        item("Der Körper schwingt", card_world, "S4", label="BODY · MODEL"),
        ...
        item("Doch die Zahnräder", card_evidence, "S4", label="NO DEMONSTRATED BRIDGE"),
        ...
        item("Nicht dokumentiert", card_evidence, "S5", label="NOT DOCUMENTED"),
        ...
        item("Eine in Focus 15", card_focus, "S6", label="PAST · FOCUS 15"),
        ...
        item("kein Beleg für Gateway", card_evidence, "S7", label="NOT THE WHOLE SYSTEM"),
        ...
        item("Selbst ein klarer", card_evidence, "S7", label="SMALL EFFECT ≠ LARGE CLAIM"),
        ...
        item("eigentliche Beweislücke", card_evidence, "S7", label="THE EVIDENCE GAP"),
        ...
        item("keinen belastbaren", card_evidence, "S8", label="NO OPERATIONAL EVIDENCE"),
