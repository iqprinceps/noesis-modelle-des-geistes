#!/usr/bin/env python3
"""EP02 Gateway V7 — Voice-Master bauen und ausrichten.

Baut aus den acht George-Stems den durchgehenden VO-Master (gleiche
Bauweise wie V2: Vorlauf, Stems auf -18 LUFS, Pausen dazwischen, Nachlauf)
und holt dann das Forced Alignment gegen die Reinschrift.

Das Alignment laeuft ausdruecklich gegen `07_VOICE_SCRIPT_CLEAN_V7.txt`,
...
MASTER = MDIR / "EP02_GATEWAY_V7_VO_MASTER.wav"
