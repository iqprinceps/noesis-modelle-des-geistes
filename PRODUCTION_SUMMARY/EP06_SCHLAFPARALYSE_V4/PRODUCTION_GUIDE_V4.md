# EP06 — Production Guide V4

**Status:** READY FOR PRODUCTION INPUTS  
**Episode:** Schlafparalyse I — Du bist wach. Dein Körper nicht.  
**Canonical script:** `03_EPISODEN/TYPE_B/EP06_SCHLAFPARALYSE_01/DREHBUCH.md`  
**Clean voice:** `PRODUCTION_SUMMARY/EP06_SCHLAFPARALYSE_V4/07_VOICE_SCRIPT_CLEAN_V4.txt`
...
```
Before the full batch, pronunciation-test: David Hufford, Old Hag, REM-Atonie, J. Allan Cheyne, Incubus, Takeuchi.

## 4. Images
Use `03_EPISODEN/TYPE_B/EP06_SCHLAFPARALYSE_01/NANOBANANA_GUIDE_V4.md` and the four S1–S8 batch files. Generate style anchors first. MAIN/RESERVE prompts are coverage, not a mandate to use every frame.
