# EP07 — Production Guide V4

**Status:** READY FOR PRODUCTION INPUTS  
**Episode:** Schlafparalyse II — Wer sitzt auf deiner Brust?  
**Canonical script:** `03_EPISODEN/TYPE_B/EP07_SCHLAFPARALYSE_02/DREHBUCH.md`  
**Clean voice:** `PRODUCTION_SUMMARY/EP07_SCHLAFPARALYSE_V4/07_VOICE_SCRIPT_CLEAN_V4.txt`
...
From repo root:
```bash
elevenlabs_cli.py batch --batch-file PRODUCTION_SUMMARY/EP07_SCHLAFPARALYSE_V4/voice/voice_batch_v4.json --execute
python3 tools/schlafparalyse_voice.py EP07 all
```
Before the full batch, pronunciation-test: Richard Coman, Bridget Bishop, Henry Füssli, Kanashibari, David Hufford, Baland Jalal, Devon Hinton.

## 4. Images
Use `03_EPISODEN/TYPE_B/EP07_SCHLAFPARALYSE_02/NANOBANANA_GUIDE_V4.md` and the four S1–S8 batch files. Generate style anchors first. MAIN/RESERVE prompts are coverage, not a mandate to use every frame.
